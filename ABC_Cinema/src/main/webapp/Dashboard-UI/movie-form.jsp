    ...
    <div class="card" style="background-color: rgba(255, 255, 255, 0.26);">
        <div class="card-body" style="color:white;">
                <form action="#" method="post">
                    ...
                    <fieldset class="form-group">
                        <label>Movie Background Image</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="MovieBgImageURL"
                                   aria-describedby="inputGroupFileAddon01">
                            <label class="custom-file-label" for="MovieBgImageURL">Choose file</label>
                        </div>
                    </fieldset>

                    <fieldset class="form-group">
                        <label>Movie Card Image</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="MovieCardImageURL"
                                   aria-describedby="inputGroupFileAddon01">
                            <label class="custom-file-label" for="MovieCardImageURL">Choose file</label>
                        </div>
                    </fieldset>

                    <fieldset class="form-group">
                        <label>Movie Description</label> <textarea class="form-control" name="MovieDescription"></textarea>
                    </fieldset>
