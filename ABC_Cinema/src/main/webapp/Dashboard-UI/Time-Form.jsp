            ...
            <form action="#" method="post">
                ...
                <fieldset class="form-group">
                    <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                        ...
                        <option value="1">28th December</option>
                        <option value="2">30th December</option>
                    </select>
                </fieldset>
                ...
                <fieldset class="form-group">
                    <label>Movie Time</label> <input type="text"  class="form-control" name="MovieTime" placeholder="12.30 P.M">
                </fieldset>
